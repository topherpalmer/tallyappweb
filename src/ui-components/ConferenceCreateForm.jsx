...
export default function ConferenceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSeasonOfYear(initialValues.seasonOfYear);
    setErrors({});
  };
  const validations = {
    name: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Conference(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ConferenceCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
