...
export default function TeamStatsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTimeouts(initialValues.timeouts);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TeamStats(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TeamStatsCreateForm")}
      {...rest}
    >
      <TextField
        label="Game id"
