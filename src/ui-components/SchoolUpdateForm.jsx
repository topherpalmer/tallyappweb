...
export default function SchoolUpdateForm(props) {
  ...
  const [mascot, setMascot] = React.useState(initialValues.mascot);
  ...
  const resetStateValues = () => {
    ...
    setMascot(cleanValues.mascot);
    setImageUrl(cleanValues.imageUrl);
    setSchoolCodes(cleanValues.schoolCodes ?? []);
    setCurrentSchoolCodesValue("");
    setErrors({});
  };
  ...
  const [currentSchoolCodesValue, setCurrentSchoolCodesValue] =
    React.useState("");
  const schoolCodesRef = React.createRef();
  const validations = {
    name: [],
    address: [],
    city: [],
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.mascot ?? value;
          }
          if (errors.mascot?.hasError) {
            runValidationTasks("mascot", value);
          }
          setMascot(value);
        }}
        onBlur={() => runValidationTasks("mascot", mascot)}
        errorMessage={errors.mascot?.errorMessage}
        hasError={errors.mascot?.hasError}
        {...getOverrideProps(overrides, "mascot")}
      ></TextField>
      <TextField
        label="Image url"
        isRequired={false}
      ...
      <ArrayField
        onChange={async (items) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            values = result?.schoolCodes ?? values;
          }
          setSchoolCodes(values);
          setCurrentSchoolCodesValue("");
        }}
        currentFieldValue={currentSchoolCodesValue}
        label={"School codes"}
        items={schoolCodes}
        hasError={errors?.schoolCodes?.hasError}
        runValidationTasks={async () =>
          await runValidationTasks("schoolCodes", currentSchoolCodesValue)
        }
        errorMessage={errors?.schoolCodes?.errorMessage}
        setFieldValue={setCurrentSchoolCodesValue}
        inputFieldRef={schoolCodesRef}
        defaultFieldValue={""}
      >
        <TextField
          label="School codes"
          isRequired={false}
          isReadOnly={false}
          value={currentSchoolCodesValue}
          onChange={(e) => {
            let { value } = e.target;
            if (errors.schoolCodes?.hasError) {
              runValidationTasks("schoolCodes", value);
            }
            setCurrentSchoolCodesValue(value);
          }}
          onBlur={() =>
            runValidationTasks("schoolCodes", currentSchoolCodesValue)
          }
          errorMessage={errors.schoolCodes?.errorMessage}
          hasError={errors.schoolCodes?.hasError}
          ref={schoolCodesRef}
