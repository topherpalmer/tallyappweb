...
export declare type GameUpdateFormValidationValues = {
    ...
    hudlUrl?: ValidationFunction<string>;
    totalAttendance?: ValidationFunction<number>;
};
...
export declare type GameUpdateFormOverridesProps = {
    ...
    hudlUrl?: PrimitiveOverrideProps<TextFieldProps>;
    totalAttendance?: PrimitiveOverrideProps<TextFieldProps>;
} & EscapeHatchProps;
