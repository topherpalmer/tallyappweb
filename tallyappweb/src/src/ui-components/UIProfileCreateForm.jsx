...
export default function UIProfileCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setBaseColor(initialValues.baseColor);
    setSecondaryColor(initialValues.secondaryColor);
    setTertiaryColor(initialValues.tertiaryColor);
    setPrimaryImage(initialValues.primaryImage);
    setSecondaryImage(initialValues.secondaryImage);
    setShopifyStatus(initialValues.shopifyStatus);
    setShopifyURL(initialValues.shopifyURL);
    setShopifyToken(initialValues.shopifyToken);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UIProfile(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UIProfileCreateForm")}
      {...rest}
    >
      <TextField
        label="Base color"
