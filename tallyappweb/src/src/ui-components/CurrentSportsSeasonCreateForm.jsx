...
export default function CurrentSportsSeasonCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSeasonName(initialValues.seasonName);
    setErrors({});
  };
  const validations = {
    year: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CurrentSportsSeason(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CurrentSportsSeasonCreateForm")}
      {...rest}
    >
      <TextField
        label="Year"
